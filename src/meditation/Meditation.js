...
import "./Medi.css";
import Medit from "./images/Medit.svg";
...
export default function Meditation() {
    return (
        <>
            <div id="Medi">
                <div className="M-head dark:text-white">Guided Meditation</div>
                <div className="medi-container dark:text-white">
                    {/* <div className="text-container"> */}
                        <div className="M-body dark:text-white"><p> Practicing mindfulness techniques before attention demanding tasks results in better focus, comprehension and awareness. We recommend you try these instructions for a fulfulling meditation seesion. </p><b/>
                    ...
                    <div className="M-image"><img src={Medit}></img></div>
